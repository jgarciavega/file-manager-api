...
export default function FiltrosInformes({ dateStart, setDateStart, dateEnd, setDateEnd, userFilter, setUserFilter, typeFilter, setTypeFilter, exportCSV, darkMode }) {
  ...
  <div className="flex flex-col justify-start h-full">
        ...
        <button
          type="button"
          onClick={exportCSV}
          className="px-4 py-2 rounded-lg bg-gradient-to-r from-green-600 to-blue-500 text-white font-bold shadow-lg hover:from-green-700 hover:to-blue-600 transition-all dark:shadow-blue-900/40"
