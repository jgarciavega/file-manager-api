    ...
    <>
      ...
      <nav className="relative flex items-center justify-between px-4 py-4 bg-white shadow-md w-full h-50">
        ...
        <div className="flex flex-col items-start">
          ...
          {/* 🔹 Título */}
          <div>
            <h1 className="text-1xl font-extrabold text-gray-600 mt-1 tracking-wide">
        ...
        {/* 🔹 Botón Hamburguesa */}
        <button onClick={toggleSidebar} className="text-blue-800 text-3xl p-3 hover:bg-gray-200 rounded-md transition">
      ...
      <div className="relative shadow-md w-full">
        ...
        <div className="absolute top-0 right-0 w-1/2 h-full flex items-center p-8 bg-black bg-opacity-50 rounded-lg">
          <div className="w-2/3 text-white text-justify">
            <h2 className="text-4xl font-semibold tracking-wide mb-4">Bienvenido</h2>
            <p className="text-lg leading-relaxed">
              Se han enviado a tu cuenta nuevos archivos, puedes revisarlos directamente mediante esta sección.
            </p>
            <button className="mt-6 px-6 py-3 bg-transparent text-white border border-white rounded-md 
             hover:bg-white hover:text-black hover:shadow-lg transition-all duration-300 flex items-center">
              Consultar
      ...
      <div className={`${styles.container} p-6 grid grid-cols-1 md:grid-cols-2 gap-6`}>
        ...
        <div className={`${styles.customBox} p-4 rounded-md shadow hover:bg-blue-400 relative`}>
          ...
          <h1 className="text-3xl font-bold text-black">Documentos Pendientes</h1>
          <h4 className="text-green-800 text-2xl mt-3">
