  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage(result.message || "Hubo un error al restablecer la contraseña");
      }
    } catch (error) {
  ...
  return (
    <div className="relative w-full h-screen flex justify-center items-center text-black">
      ...
      <div className="bg-white shadow-xl p-8 w-[480px] border-2 rounded-lg min-h-[420px]">
        ...
        <h2 className="text-xl font-bold text-center text-gray-800 mb-6">Restablecer contraseña</h2>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <input 
            ...
            className="w-full px-4 py-2 border-b-2 border-gray-400 outline-none"
          />
          <button type="submit" className="w-full py-3 text-white bg-[#813441] hover:bg-[#5f2730] rounded-xl">Restablecer</button>
        </form>
